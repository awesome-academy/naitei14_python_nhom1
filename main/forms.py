...
from .models import Pitch, PitchTimeSlot, User, Review, Voucher
...
class SignUpForm(UserCreationForm):
    ...
    def validate_password_strength(self, password):
        ...
        if char_type_count < 3:
            errors.append(
                "Mật khẩu phải chứa ít nhất 3 trong 4 loại ký tự: chữ thường, chữ hoa, số và ký tự đặc biệt.")
        return errors
...
class VoucherForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            "min_order_value": "Giá trị tối thiểu",
    ...
    def clean_discount_percent(self):
        ...
        if percent is not None and (percent < 0 or percent > 100):
            raise ValidationError("Phần trăm giảm phải trong khoảng 0-100.")
        return percent
from django import forms
from django.contrib.auth.forms import UserCreationForm
from django.core.exceptions import ValidationError
...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['password1'].help_text = (
            "Mật khẩu phải có ít nhất 8 ký tự và chứa ít nhất 3 trong các loại sau: "
            "chữ thường, chữ hoa, số, ký tự đặc biệt."
        )
        self.fields['password2'].label = "Xác nhận mật khẩu"
    ...
    def validate_password_strength(self, password):
        ...
        if char_type_count < 3:
            errors.append(
                "Mật khẩu phải chứa ít nhất 3 trong các loại sau: chữ thường, chữ hoa, số, ký tự đặc biệt.")
        return errors
